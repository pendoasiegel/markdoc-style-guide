...
You can switch between apps with the dropdown menu in Pendo. You can also use this functionality as high-level segmentation for dashboard widgets and behavior tools.
